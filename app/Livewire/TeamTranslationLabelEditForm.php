...
class TeamTranslationLabelEditForm extends Component implements HasForms, HasActions
{
    ...
    // Question: how does this class to be called?
    ...
    {
        return view('livewire.team-translation-label-edit-form');
    }
}
