...
{{--        --}}
{{--        <x-slot:mark-as-completed-when/>you have completed the LISP worksop and added the local indicators indicated by local stakeholders.</x-slot>--}}
