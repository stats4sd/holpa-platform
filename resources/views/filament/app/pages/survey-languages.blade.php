...
<div class="container mx-auto xl:px-12 ">
    ...
    <!-- <div class="completebar ">
        ...
        <div class="mb-6 mx-auto md:mr-24 md:ml-0 md:inline-block block text-green ">
            ...
            <a href="" class="buttonb block max-w-sm mx-auto md:mx-4 md:inline-block mb-6 md:mb-0">Go back</a>

        <a href="" class="buttona block md:inline-block mb-6 md:mb-0 max-w-sm mx-auto "><span class="font-extrabold mr-2 ">X</span> MARK AS INCOMPLETE</a>
    </div> -->
