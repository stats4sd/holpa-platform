    ...
    <div class="container mx-auto xl:px-12 ">
        <div class="surveyblocks pt-16 pb-24 mb-32 px-12 lg:px-16">
            ...
            <ol class="list-disc py-4 px-10">
                <li class="mb-2"><span class="font-semibold">Activity 0: Introductions and coming together </span> <br>
                ...
                <li class="mb-2"><span class="font-semibold">Activity 1: Anchoring the workshop (Where are we and where do we want to go? Review of the ALL’s Context and Vision)</span><br>
                ...
                <li class="mb-2"><span class="font-semibold">Activity 2: Indicator brainstorming (How will we know if we get there?) </span><br>
                ...
                <li class="mb-2"><span class="font-semibold">Activity 3: Indicator criteria and evaluation (What makes a good indicator?) </span><br>
                ...
                <li class="mb-2"><span class="font-semibold">Activity 4:  Agreeing on priority local indicators </span><br>
                ...
                <li class="mb-2"><span class="font-semibold">Activity 5: Workshop Close </span><br>
                <p>A final discussion should be facilitated to gain consensus amongst the stakeholders on the priority indicators selected under each of the four themes. There should be an overall agreement on the fact that the selected indicators are the most appropriate and measurable to determine the progress towards the envisioned future in transitioning towards agroecology. </p>
                </li>
            </ol>
            </div>
