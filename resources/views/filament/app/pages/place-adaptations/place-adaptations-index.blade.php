...
<h5>Contextualise choice lists</h5>
 ...
 <p class="mb-2"> 
There are some questions in the survey where the appropriate answer options will be different depending on the location context - for example, questions that ask about crops that are grown on a farm <i>should not</i> include lots of options for plants that do not grow in the location being surveyed, and <i>should</i> include the most commonly grown crops in that area. Questions should also reflect the units of measurement that are used in the location.
</p>
 <p class="mb-2"> 
