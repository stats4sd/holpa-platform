    ...
    <div class="w-full ">
        ...
        <div class="bg-white shadow-md pt-8 ">
            <div class="container mx-auto xl:px-32">
                ...
                <!-- Heading -->
                <h1 class="text-green  text-left  mb-8">HOLPA Survey Dashboard</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    ...
                    <div class="p-4 rounded-md">
                        ...
                        <div class="text-center">
                            <a href="{{ url(MoreInstructions::getUrl()) }}" class="bg-orange text-white font-semibold text-sm py-2 px-6 rounded-full hover-effect">
                                FIND OUT MORE
                            </a>
                        </div>
                    </div>
