...
<x-instructions-sidebar>
        ...
        <x-slot:instructions>
            ...
            <div class="mx-12 mb-4">
                ...
                <li class="mb-1">
                Published all changes to update the forms you will use in the pilot. <br>This must be done manually; this is so that you can make changes and test them as draft versions to confirm they are working as expected before updating the versions that your enumerator team will see. You will find the option to publish your changes on the "Access forms"    section of the page. 
                </li>
                </ul>
                <p class="mb-2">
