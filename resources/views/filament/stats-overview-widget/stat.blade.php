...
<div class="grid gap-y-2">
    <div
        class="fi-wi-stats-overview-stat-value text-3xl font-semibold tracking-tight text-gray-950 dark:text-white text-center"
    >
        {{ number_format($getValue()) . $getSuffix() }}
    </div>
    <div class="flex items-center gap-x-2">
        ...
        <span
            class="w-full fi-wi-stats-overview-stat-label text-lg font-medium text-gray-500 dark:text-gray-400 text-center"
        >
                {!! $getLabel() !!}
            </span>
    </div>
