...
class Container_7ae249c80e extends _PHPStan_f2f2ddf44\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.methodsClassReflectionExtension' => ['0117' => true],
		'phpstan.broker.allowedSubTypesClassReflectionExtension' => ['0118' => true],
		'phpstan.broker.propertiesClassReflectionExtension' => ['0119' => true, '0284' => true],
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['098', '0112', '0114', '0115', '0119', '0284']],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0224', '0227', '0229', '0242', '0348', '0354']],
		...
		'PHPStan\Collectors\Collector' => [['0404', '0405', '0406', '0407', '0408', '0409', '0410', '0431', '0432']],
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7ae249c80e $container)
			{
	...
	public function createServiceContainer(): Container_7ae249c80e
	{
		return $this;
	}
