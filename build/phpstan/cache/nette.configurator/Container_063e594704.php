...
class Container_063e594704 extends _PHPStan_f2f2ddf44\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_063e594704 $container)
			{
	...
	public function createServiceContainer(): Container_063e594704
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PYENV_SHELL' => 'zsh',
				'OLDPWD' => '/',
				'XPC_SERVICE_NAME' => 'application.com.jetbrains.PhpStorm.966272.630663053',
				'PAGER' => 'less',
